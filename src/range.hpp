// Appache 2.0 License: http://www.apache.org/licenses/LICENSE-2.0
// From github.com/klmr/cpp11-range
// File modified to include license and attribution
...
struct range_proxy {
    ...
    //range_proxy(T end) : begin_(0), end_(end) { }
